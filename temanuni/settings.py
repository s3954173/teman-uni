"""
Django settings for temanuni project.
...
SECRET_KEY = 'django-insecure-8o1sa@0dmy-(s@7&u8gcrs2qq(mg+1#j*8)5n-lugb=kg35!sa'
...
INSTALLED_APPS = [
    ...
    'tmProfile.apps.tmProfileConfig',
...
WSGI_APPLICATION = 'temanuni.wsgi.application'
